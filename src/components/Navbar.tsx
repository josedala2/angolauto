...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 md:top-8 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "glass-card border-b border-border/50 shadow-lg" : "bg-transparent border-b border-transparent"}`}>
